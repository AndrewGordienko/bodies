...
def update_plots():
    ...
    # Update the convergence plot separately if needed
    ...
    # Recalculate limits and redraw for all plots
    for ax in axs.flat:
        ax.relim()  # Recalculate limits
        ax.autoscale_view()  # Rescale view based on limits

    # Specific handling for the convergence plot (if using the same axis for actor and critic)
    axs[2, 1].relim()

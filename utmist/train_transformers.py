...
env = SoccerEnv()
env.play_game(random_policy, replay_buffer, num_games=10)
...
torch.save(model_ball.state_dict(), 'model_ball.pth')
torch.save(model_players.state_dict(), 'model_players.pth')
...
# Visualization for both Ball Transformer and Players Transfo.rmer
